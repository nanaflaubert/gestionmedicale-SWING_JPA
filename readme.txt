...
GestionMedicale est une application qui permet de selon l'option choisit:
	-Enregistrer: ceci permet à un patient de s'enregistrer
...
Pour lancer phpMyAdmin vous pouvez aussi saisir directe sur votre navigateur l'url suivant: http://localhost/phpmyadmin/
	Dans Mysql, créer la base données "gestionmedicale" et importer la table "patient" en suivant les inctructions suivantes:
	-sur l'onglet "Base de Données" dans le champ "Créer une base de données" saisir "formation" 
	 puis cliquer sur créer (Bravo! vous avez créer la base données "gestionmedicale")
